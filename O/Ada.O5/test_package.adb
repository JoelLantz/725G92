...
package body Test_Package is
   ...
   procedure Check_Date(S : in Date_Type) is
      

   begin
      Check_Year(S.Year);
      Check_Month(S.Month);
      if Check_Leap(S.Year) then 
	 Check_Day_Leap(S.Month, S.Day);
      else
	 Check_Day(S.Month, S.Day);
      end if;
   ...
   begin
	 ...
	 return (Left.Month = Right.Month and Left.Day < Right.Day) or (Left.Month < Right.Month);	 
      else
	 return False;
      end if;
   ...
   begin
	 ...
	 return not (Left < Right);
      ...
      -- vi har nått som kan beräkna A < B 
      -- hur beräknar vi A > B
